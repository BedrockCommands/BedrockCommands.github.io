...
const TaskBoard = {
  ...
  setup() {
    ...
    const knownUsernames = ref(["ax_titan", "bm6", "brodblox09", "califerr", "catfederation", "ccjjkk95", "cornyflex", "crepaspmkinpie", "crunchycookie", "dinosscar", "faramir1616", "itzbeasty", "thejonathanlongly", "jeanmajid", "kittenb0y", "nayvid", "poolroxjosh", "r_kidds", "sheep_shiloh", "spacebarninja", "theemonster395", "vactricaking", "veyscold", "your_friend6254", "zheaevyline", "zruby"])
    // Usernames with dot
